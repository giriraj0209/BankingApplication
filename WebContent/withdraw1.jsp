...
<div class="form-group">
    <label for="selw">Select Customer:</label>
<select class="form-control" id="selw" name="custId">
    <%          if (customers != null) {
    ...
    <input type="text" id="wamt" name="amount" placeholder="0.0" class="form-control" required/><br>
