...
<input type="text" id="usr" name="fname" class="form-control" value="<%=customer.getFirstName()%>" /><br>
<label for="usr1">Last Name:</label>
<input type="text" id="usr1" name="lname"  class="form-control" value="<%=customer.getLastName()%>" />
<br>
