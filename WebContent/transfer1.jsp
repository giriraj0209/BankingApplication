...
<div class="form-group">
    <label for="selc1">Select Customer FROM:</label>
<select class="form-control" id="selc1" name="custId1">
    <%
                                                                        if (customers != null) {
  ...
  <label for="selc2">Select Customer TO:</label>
  <select class="form-control" id="selc2" name="custId2">
      <%
                                                                        if (customers != null) {
                                                                            for (int i = 0; i < customers.size(); i++) {
                                                                                Customer customer = customers.get(i);
...
<label for="amtq">Amount:</label>
<input type="text" name="amount" id="amtq" placeholder="0.0" class="form-control" required /><br>
